...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Transport Management System API for Ethiopian Defence University. Provides fleet, driver, passenger, compliance, fuel, garage, contract, and reporting endpoints.',
    ],

    /*
     * In production, restrict access to the API docs to authenticated admins only.
     * The RestrictedDocsAccess middleware (see 'middleware' key below) gates access;
     * additionally, the docs route registration is skipped in config/app.php
     * service providers when APP_ENV=production and no admin auth guard is configured.
     */
